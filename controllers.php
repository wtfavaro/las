  ...
  $_POST["data"] = json_encode(
                      array(
                          array(
                            "Name"          => "CM 92.log",
                            "Size"          => "618",
                            "Path"          => "\Freepoint\CellMonitor\Story.LOG",
                            "DateCreated"   => "121094212",
                            "DateModified"  => "129128283",
                            "Extension"     => "LOG"
                          ),
                          array(
                            "Name"          => "CM 93.log",
                            "Size"          => "1028",
                            "Path"          => "\Freepoint\CellMonitor\Story2.LOG",
                            "DateCreated"   => "121094213",
                            "DateModified"  => "129128284",
                            "Extension"     => "LOG"                            
                          )
                    ));

  $_POST["software_key"] = "ASD12%$*#KF*";
*/

  if (isset($_POST["software_key"])){
      $strSoftwareKey = $_POST["software_key"];
  } else {
    echo "0";
    die;
  }
