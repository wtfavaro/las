  ...
  <div class="row">
    <div class="container">
      ...
      <div id="section-liveData" style="display: none;">
        <div id="liveData" class="col-md-offset-2 col-md-8 text-center" style="padding: 25px 0px;">
          <!-- output table -->
          <table style="width: 100%; text-align: left; padding: 20px;">
            <tr>
              <th style="width: 50%; max-width: 25%;">Input</th>
              <th style="width: 10%; max-width: 10%;">State</th>
              <th style="width: 20%; max-width: 20%;">Timer</th>
              <th style="width: 20%; max-width: 20%;">Counter</th>
            </tr>
            <tr>
              <td>INPUT1</td>
            </tr>
