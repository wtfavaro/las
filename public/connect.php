    ...
    <span id="form-container" class="col-md-offset-3 col-md-6">
      <div class="limit-to-80">
        <div class="form-group">
            <input type="text" class="form-control input-modern" id="inp-email" placeholder="me@example.com">
        </div>
        ...
        <div class="text-center">
          <span class="btn btn-primary btn-lg" id="btnLogin">LOGIN</span>
        </div>
      </div>
    </span>
...
<script type="text/javascript">
  ...
  var form = { 
    ...
    'password': false,
    checkValid: function(){
      if (form.email===true && form.password===true){
...
// Make certain that the password is okay.
  ...
  $('#btnLogin').click(function(){
    ...
    httprequest('User', 'match', data, function(resp){
